package com.ghang.search.qa.service;
...
import com.ghang.search.qa.dao.ProblemDao;
...
public class ProblemService {
	...
	// 最新问答列表
	public Page<Problem> newReply(String labelid,int page,int size){
		Pageable pageable = PageRequest.of(page-1, size);
		return problemDao.newlist(labelid,pageable);
	}

	// 热门问答列表
	public Page<Problem> hotReply(String labelId,int page,int size){
		Pageable pageable = PageRequest.of(page-1, size);
		return problemDao.hotlist(labelId,pageable);
	}

	// 等待回答列表
	public Page<Problem> waitReply(String  labelId,Integer page,Integer size){
		Pageable pageable = PageRequest.of(page-1, size);
