package com.ghang.search.qa.controller;

import java.util.Map;


import com.ghang.search.qa.pojo.Problem;
import com.ghang.search.qa.service.ProblemService;
...
public class ProblemController {
	...
	public Result newlist(@PathVariable String labelid,@PathVariable Integer page, @PathVariable Integer size){
		Page<Problem> problemPage = problemService.newReply(labelid, page, size);
	...
	public Result hotlist(@PathVariable String labelid,@PathVariable Integer page,@PathVariable Integer size ){
		Page<Problem> problems = problemService.hotReply(labelid, page, size);
	...
	public Result waitlist(@PathVariable String labelid,@PathVariable Integer page,@PathVariable Integer size){
		Page<Problem> problems = problemService.waitReply(labelid, page, size);
